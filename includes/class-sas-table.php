...
class Sas_Table {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sas_Table_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	/**
	 * The current path to the plugin directory.
	 *
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $version    The current path of the plugin.
	 */
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once $this->plugin_dir_path . 'includes/class-sas-table-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once $this->plugin_dir_path . 'includes/class-sas-table-i18n.php';

		/**
		 * The class responsible for defining all shortcodes that occur in the public-facing
		 * side of the site.
		 */
		require_once $this->plugin_dir_path . 'includes/class-sas-table-shortcode.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once $this->plugin_dir_path . 'admin/class-sas-table-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once $this->plugin_dir_path . 'public/class-sas-table-public.php';

		$this->loader = new Sas_Table_Loader();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sas_Table_Loader    Orchestrates the hooks of the plugin.
	 */
